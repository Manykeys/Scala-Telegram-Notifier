...
class StackoverflowCommentsClient[F[_] : Async, B <: SttpBackend[F, _]](token: String, backend: B) extends CommentsClient[F] {
...
object CommentsClientFactory {
  def create[F[_]: Async](token: String, identifier: String, backend: sttp.client3.SttpBackend[F, _]): CommentsClient[F] =
